                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form class="form-horizontal"
                                                action="{{ route('equipment.update',$list->id) }}" method="POST"
...
<div class="row">
                                                    <div class="form-group">
                                                        <label for="equipment_image"
                                                            class="col-sm-3 control-label">เลือกรูปภาพ
                                                            :</label>
                                                        <div class="col-sm-8">
...
<div class="row">
                                                    <div class="form-group">
                                                        <label for="equipment_code"
                                                            class="col-sm-3 control-label">รหัสครุภัณฑ์
                                                            :</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="equipment_code"
                                                                name="equipment_code"
                                                                value="{{ $list->equipment_code }}" readonly>
                                                        </div>
                                                    </div> <!-- /form-group-->
</div>
<br>
<div class="row">
                                                    <div class="form-group">
                                                        <label for="equipment_name"
                                                            class="col-sm-3 control-label">ลักษณะ/ยี่ห้อ
                                                            :</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="equipment_name"
                                                                name="equipment_name"
                                                                value="{{ $list->equipment_name }}">
                                                        </div>
                                                    </div> <!-- /form-group-->
</div>
<br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control" name="equipment_role"
                                                                ...
                                                                <option value="2"
                                                                    {{ $list->equipment_role == 2 ? 'selected' : '' }}>
                                                                    ทุกคน
                                                                </option>
                                                            </select>
                                                        </div>
...
<div class="row">
                                                    <div class="form-group">
                                                        <label for="equipment_status"
                                                            class="col-sm-3 control-label">สถานะ :
                                                        </label>
                                                        <div class="col-sm-8">
                                                            <select class="form-control" id="equipment_status"
                                                                name="equipment_status">
                                                                <option value="1"
                                                                    {{ $list->equipment_status == 1 ? 'selected' : '' }}>
                                                                    ว่าง
                                                                </option>
                                                                <option value="2"
                                                                    {{ $list->equipment_status == 2 ? 'selected' : '' }}>
                                                                    ไม่ว่าง
                                                                </option>
                                                                <option value="3"
                                                                    ...
                                                                    ซ่อม/รอซ่อม</option>
                                                                <option value="4"
                                                                    {{ $list->equipment_status == 4 ? 'selected' : '' }}>
                                                                    ชำรุด
                                                                </option>
                                                                <option value="5"
                                                                    {{ $list->equipment_status == 5 ? 'selected' : '' }}>
                                                                    บริจาค
                                                                </option>
                                                                <option value="6"
                                                                ...
                                                                <option value="7"
                                                                    ...
                                                                    ขายทอดตลาด</option>
                                                                <option value="8"
                                                                    {{ $list->equipment_status == 8 ? 'selected' : '' }}>
                                                                    โอน
                                                                </option>
                                                            </select>
                                                        </div>
...
<div class="row">
                                                    <div class="form-group">
                                                        <label for="equipment_etc"
                                                            class="col-sm-3 control-label">หมายเหตุ :
                                                        </label>
                                                        <div class="col-sm-8">
                                                    ...
                                                    <div class="modal-footer editProductFooter">
                                                        <button type="button" id="clostProductModal"
                                                            class="btn btn-default" data-dismiss="modal">
                                                            <i class="glyphicon glyphicon-remove-sign"></i>
                                                            ปิด</button>

                                                        <button type="submit" class="btn btn-success"
                                                            id="editProductBtn" data-loading-text="Loading..."> <i
                                ...
                                <div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" role="dialog"
                                    id="removeEquipmentModal{{ $list->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('categorieslist.destroy',$list->id) }}"
                                                method="POST">
                                                @csrf
                                                {{method_field('delete')}}
                                                <div class="modal-body">
                                                ...
                                                <div class="modal-footer removeCategoriesFooter">
                                                    ...
                                                    <button type="submit" class="btn btn-primary"
                                                        id="removeCategoriesBtn" data-loading-text="Loading...">
