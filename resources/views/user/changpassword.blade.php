                            ...
                            <div class="bio-info">
                                <div class="row">
                                    ...
                                    <form method="POST" action="php_action/update_password.php">
                                        ...
                                        <div class="form-group">
                                            <label for="password">รหัสผ่านเดิม *</label>&nbsp;<span class="badge badge-info"
                                        ...
                                        <div class="form-group">
                                            <label for="newpassword">รหัสผ่านใหม่ *</label>&nbsp;<span class="badge badge-info"
                                                style="font-weight:normal;">(กรอกอักษร a-z,A-z และตัวเลข 0-9 จำนวน 6-10
                                                ตัวเท่านั้น)</span>
                                        ...
                                        <div class="form-group">
                                            <label for="passwordconfirm">ยืนยันรหัสผ่าน *</label>&nbsp;<span class="badge badge-info"
                                                style="font-weight:normal;">(กรอกอักษร a-z,A-z และตัวเลข 0-9 จำนวน 6-10
                                                ตัวเท่านั้น)</span>
                                            <input type="password" class="form-control" id="passwordconfirm" name="passwordconfirm"
                                                pattern="[A-Za-z0-9]{6,10}" placeholder="Confirm Password" autocomplete="off"
                                                required>
                                            <!-- <small id="emailHelp" class="form-text text-muted">Password incorrect.</small> -->
                                        </div>
                                        <br>
                            ...
                            <div class="bio-info">
                                <div class="row">
                                    <form method="POST" action="php_action/update_password.php">
                                        ...
                                        <div class="form-group">
                                            <label for="passwordconfirm">ยืนยันรหัสผ่านใหม่ *</label>&nbsp;<span class="badge badge-info"
                                                style="font-weight:normal;">(กรอกอักษร a-z,A-z และตัวเลข 0-9 จำนวน 6-10
                                                ตัวเท่านั้น)</span>
                                            <input type="password" class="form-control" id="passwordconfirm" name="passwordconfirm"
                                                pattern="[A-Za-z0-9]{6,10}" placeholder="Confirm Password" autocomplete="off"
